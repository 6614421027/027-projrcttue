        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="mb-0 text-dark"><i class="bi bi-person-plus-fill text-primary me-2"></i>เพิ่มข้อมูลพนักงานใหม่</h3>
                ...
                <form action="{{ route('employees.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="employee_code" class="form-control" value="{{ old('employee_code') }}" placeholder="เช่น EMP001">
                        </div>
                        <div class="col-md-3 mb-3">
