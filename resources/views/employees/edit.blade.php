...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="mb-0 text-dark fw-bold"><i class="bi bi-pencil-square text-warning me-2"></i>แก้ไขข้อมูลพนักงาน</h4>
    ...
    <div class="card-body p-4">
        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="salary" class="form-control border-start-0" value="{{ old('salary', $employee->salary) }}">
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <div class="d-flex justify-content-end gap-2">
                <button type="submit" class="btn btn-warning px-4 rounded-pill shadow-sm"><i class="bi bi-save me-1"></i> บันทึกการแก้ไข</button>
            </div>
        </form>
    </div>
</div>
